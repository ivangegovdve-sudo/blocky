...
func (v *Validator) validateDenialOfExistence(
	...
	if result != ValidationResultSecure {
		v.logger.Warn("authority section validation failed for denial of existence",
	...
	v.logger.Warn("no NSEC/NSEC3 records found for denial of existence", slog.String("qname", question.Name))
